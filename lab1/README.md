...
Выберите один из вариантов домашних работ из файла [`homework_variants.pdf`](https://github.com/DVDemon/architecture_python/blob/66fea7e81fa345c1019b4b1a318b0b2cc5dc5aac/docs/homeworks_variants.pdf) (варианты 1-24) и выполните следующие задачи:

1. **Изучите текст задания**
    - Назначенный вариант из [`homework_variants.pdf`](https://github.com/DVDemon/architecture_python/blob/66fea7e81fa345c1019b4b1a318b0b2cc5dc5aac/docs/homeworks_variants.pdf)
...
3. **Создайте описание sofwareSystem и диаграмму systemContext**
...
8. **Определите технологии и поставьте их на контейнерах и связях**
...
9. **Создайте одну диаграмму dynamic для архитектурно значимого варианта использования**
    - Выберите один важный сценарий из вашего варианта (отправка сообщения между пользователями, покупка товара в магазине, созданние бронирования и т.д.)
...
**Название:** Система управления недвижимостью

**Пример:** https://www.zillow.com/
